...
export image_size="224"  #"224" #[224, 448, 672], 896
...
--pretrained "/vol/research/bioAI-GB2022/models/ImageNet/swin_tiny_patch4_window7_224.pth" \
--data-path '/vol/research/bioAI-GB2022/fundusImg/G30-G32_Other_degenerative_diseases_of_nervous_system/' \
--batch-size $batch_size \
--output '/vol/research/bioAI-GB2022/models/G30-G32_Other_degenerative_diseases_of_nervous_system/' \
...
SAVE_FREQ $SAVE_FREQ --tag "ImageNetSupervised224"
